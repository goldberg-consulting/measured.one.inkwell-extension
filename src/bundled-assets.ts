...
export const BUNDLED_ASSET_PATHS: readonly string[] = [
  ...
  "examples/demo-measured-report.md",
  "examples/mixed-report/comparison.mjs",
  "examples/mixed-report/outcomes.csv",
  "examples/mixed-report/package.json",
  "examples/mixed-report/package-lock.json",
  "examples/mixed-report/plot-helpers.mjs",
  "examples/mixed-report/summary.py",
  "examples/mixed-report/trend.py",
  "examples/mixed-report/uplift.mjs",
  "templates/measured-report/LICENSE.md",
  "templates/measured-report/measured-report.latex",
  "templates/measured-report/measured-report.sty",
  "templates/measured-report/template.json",
  ...
  "docs/tables.md",
  "filters/table-common.lua",
  "filters/table-data.lua",
  "filters/semantic-tables.lua",
  "filters/section-bibliographies.lua",
  "filters/reference-common.lua",
  "filters/reference-prepare.lua",
  "filters/reference-render.lua",
  "guide.md",
  "out/extension.js",
  "package.json",
