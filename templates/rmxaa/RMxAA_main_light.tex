...
\documentclass[9pt,twoside]{rmaa-rho-class/rmaa-rho_light}
...
\title{A Nice Paper in a Light RMxAA Template}

%----------------------------------------------------------
% AUTHORS AND AFFILIATIONS
%----------------------------------------------------------

\author[1,$\dagger$]{Peter E. Rostopovich \orcidlink{0000-0009-8765-4321}}
...
\affil[1]{State University of Malcrovia, Republic of Happyland}
...
\corres{Peter E. Rostopovich}
\email{rostop@astronomy.malcrov.hl}

\received{April 16th, 2026}
...
\section{INTRODUCTION}
    ...
    Welcome to the \rmaatex template for preparing your academic article. Articles considered for publication in the main journal can be easily prepared using this template. The style of this template is based on the \textit{rho class} style\footnote{The RMxAA paper template is based on the rho LATEX class,
...
\subsection{Sectioning commands and cross references}
    ...
    \subsubsection{Equations}
        ...
        Equation~\ref{ec:equation2} shows the Schrödinger equation as an example of an elegant equation with proper labeling.
